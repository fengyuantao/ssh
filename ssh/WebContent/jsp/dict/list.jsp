									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
													...
													<TD>
													<a href="${pageContext.request.contextPath }/jsp/dict/add.jsp">
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#dicts" var="cust" >
												<TR 		
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>
														<s:property value="#cust.dict_type_code" />
													</TD>
													<TD>
													<s:property value="#cust.dict_type_name" />
													</TD>
													<TD>
													<s:property value="#cust.dict_item_name" />
													</TD>
													<TD>
													<s:property value="#cust.dict_enable" />
													</TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<option value="1" <c:if test="${pageCount==1 }">selected</c:if>>1</option>
												...
												到
												<input type="text" size="3" id="page" name="currentPage" value=""/>
												页
